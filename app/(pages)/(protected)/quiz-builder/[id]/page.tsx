...
const QuizBuilder: FC<pageProps> = ({ params }) => {
  ...
  const handleSubmit = async () => {
    await mutateAsync({ ...quizQuestion, quizId: params.id })
    setShowModal(false)
  }
    ...
    <div className="w-full text-black">
      ...
      <div className="border-2 rounded-md bg-white border-base mt-10 p-6 max-h-[700px] overflow-auto pb-10">
        ...
        <div className="flex flex-col gap-4 items-start w-full">
          {oneQuiz?.questions?.map((singleQuestion, questionIndex) => (
        ...
        >
          ...
          >
            ...
            <SingleQuestion
              ...
              onchange={(e) => handleChangeQuestion(e.target.value)}
              questionIndex={oneQuiz?.questions?.length as number}
              ref={textAreaRefs}
            />
            <Choices
